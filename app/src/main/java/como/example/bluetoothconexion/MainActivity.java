package como.example.bluetoothconexion;
...
//esta medio mal
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Hb =(Button)findViewById(R.id.bA);
        ot =(Button)findViewById(R.id.bHM);
        pL =(Button)findViewById(R.id.btnH);
